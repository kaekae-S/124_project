...
class Lexer:
    def __init__(self):
        ...
        self.token_patterns = [
            ...
            ("NUMBR", r"-?\d+"),            # integer numbers
            ("TROOF", r"\b(WIN|FAIL)\b"),   # boolean values
            ("YARN", r'"[^"]*"'),           # strings
            ("NOOB", r"\bNOOB\b"),          # uninitialized
    ...
    def tokenize(self, code: str):
        ...
        for line_num, line in enumerate(code.splitlines(), start=1):
            ...
            # multi-word keywords are tokenized first
            pos = 0
            while pos < len(line):
                match = None
